					...
					<view class="content-box" @click="isLogin()">
						<view  class="nickname" :style="{ color: userhome.options.infoBox.color }">
							<view style="display: flex;">
								<view  v-if="memberInfo.level_icon" style="width: 36rpx;height: 36rpx;border-radius: 30px;overflow: hidden;margin-right: 2px;margin-top: 2px;">
									<image :src="memberInfo.level_icon" style="width: 100%;height: 100%"></image>
								</view>
							...
							<view style="display: flex;padding-top: 4rpx;">
								...
								style="padding: 0px 16rpx;font-size: 10px;font-weight: 400;margin-right: 10px;height: 30rpx;line-height: 32rpx;border-radius: 30rpx;" 
								>
