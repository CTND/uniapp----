	...
	>
		<view class="u-tabbar-item__icon">
			<u-icon
			    ...
			    :size="System.tabbar.options.iconSize?System.tabbar.options.iconSize+'px':20"
			></u-icon>
			<template v-else>
				<slot
				    v-if="isActive"
		...
		<slot name="text">
			<text
			    ...
			    :style="{
					color: isActive? parentData.activeColor : parentData.inactiveColor,
					marginTop: System.tabbar.options.navmarginTop?System.tabbar.options.navmarginTop+'px':'3px'
				}"
			>{{ text }}</text>
		</slot>
	</view>
