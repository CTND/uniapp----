<template>
	<view style="padding:15px 15px 0 15px;">
		...
		<up-navbar height="50px" :autoBack="true" @rightClick="rightClick" bgColor="#ffffff">
			<template #left>
				<view class="micon icon-jiantou-copy" style="color: #303133;font-weight: bold;"></view>
			</template>
			<template #center>
				<view>金币账户</view>
			</template>
			<template #right>
				<view class="nav-right-box" >
					<text style="font-size: 14px;">账单</text>
				</view>
			</template>
		</up-navbar> -->
		<view class="card-box">
			...
			<view class="content-box">
				...
				<view class="content-title">账户余额</view>
				<view class="big-num-box">{{memberInfo.currency || 0}}</view>
				<view class="money-desc">金币可用于提现、兑换礼物等</view>
			</view>
		</view>
	</view>
...
<script>
	...
	export default{
		...
		methods:{
			...
			rightClick() {
				this.navTo('/pages_member/money/moneyRecord', {login: true}, {account_type:'currency'})
			},
		}
	}
</script>
