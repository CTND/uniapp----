<template>
	...
	:style="{height:height}">
		...
		:style="[{opacity:animating && idx == 0 ? 0 : 1},customStyle]" 
		@touchstart="touchstart" @touchend="touchend" 
		@tap="itemTap(idx)" 
		ref="scitems">
			<view v-if="item.img" :style="imgStyle" style="overflow: hidden;">
				<image
				:src="item.img" 
				mode="widthFix"
				style="width: 100%;"
			...
			<view class="gui-scrollitemsy-body gui-flex1" :style="textStyle">
				<!-- {{item.desc}} -->
				<u-parse :content="item.desc || ''" :tagStyle="{
...
export default{
	...
	props : {
		...
		imgStyle  : {type : String, default : 'width:88rpx; height:88rpx; border-radius:6rpx; margin-right:10px;'},
		textStyle : {type : String, default : 'font-size:14px;'},
